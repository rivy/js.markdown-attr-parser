...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$consts = [
        ...
        peg$otherExpectation("unicode byte-order-mark"),
        /^[\uFEFF]/,
        peg$classExpectation(["\uFEFF"], false, false),
        peg$otherExpectation("unicode '[Zs] Separator,Space'"),
        /^[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/,
        peg$classExpectation([" ", "\xA0", "\u1680", ["\u2000", "\u200A"], "\u202F", "\u205F", "\u3000"], false, false),
        peg$otherExpectation("unicode line separator"),
        /^[\u2028]/,
        peg$classExpectation(["\u2028"], false, false),
        peg$otherExpectation("unicode paragraph separator"),
        /^[\u2029]/,
        peg$classExpectation(["\u2029"], false, false),
        ...
        /^[ \t\f\x0B]/,
        peg$classExpectation([" ", "\t", "\f", "\x0B"], false, false),
        /^[\n\r]/,
      ...
      peg$bytecode = [
        ...
        peg$decode("%$;*0#*;*&/\xB2#2\"\"\"6\"7#/\xA3$$;*0#*;*&/\x93$2$\"\"6$7%/\x84$$;*0#*;*&/t$;\".\" &\"/f$$;*0#*;*&/V$2&\"\"6&7'/G$$;*0#*;*&/7$2(\"\"6(7)/($8*:**!$)(*'#()'#(('#(''#(&'#(%'#($'#(#'#(\"'#&'#.\x85 &%$;*0#*;*&/t#2$\"\"6$7%/e$$;*0#*;*&/U$;\".\" &\"/G$$;*0#*;*&/7$2&\"\"6&7'/($8&:*&!\")(&'#(%'#($'#(#'#(\"'#&'#"),
        peg$decode("%$;*0#*;*&/\x8E#;#/\x85$$%$;*/&#0#*;*&&&#/2#;#/)$8\":+\"\"$ )(\"'#&'#0I*%$;*/&#0#*;*&&&#/2#;#/)$8\":+\"\"$ )(\"'#&'#&/)$8#:,#\"! )(#'#(\"'#&'#"),
        peg$decode("%$;6/&#0#*;6&&&#/' 8!:-!! ).\xC1 &%;7/' 8!:.!! ).\xAF &%;8/A#2/\"\"6/70/2$;1/)$8#:1#\"\" )(#'#(\"'#&'#.\x81 &%;8/A#2/\"\"6/70/2$;5/)$8#:1#\"\" )(#'#(\"'#&'#.S &%;8/7#2/\"\"6/70/($8\":2\"!!)(\"'#&'#./ &%;8/' 8!:3!! )"),
        peg$decode("<45\"\"5!76=.\" 74"),
        peg$decode("<48\"\"5!79=.\" 77"),
        peg$decode("<4;\"\"5!7<=.\" 7:"),
        peg$decode("<4>\"\"5!7?=.\" 7="),
        peg$decode("<2A\"\"6A7B=.\" 7@"),
        peg$decode("<2D\"\"6D7E=.\" 7C"),
        peg$decode("<4G\"\"5!7H.) &;%.# &;$=.\" 7F"),
        peg$decode("4I\"\"5!7J.) &;&.# &;'"),
        peg$decode("2K\"\"6K7L"),
        peg$decode("4M\"\"5!7N"),
        peg$decode("4O\"\"5!7P"),
        peg$decode(";0.# &;-"),
        peg$decode("%;,/7#;(.# &;)/($8\":Q\"! )(\"'#&'#"),
        peg$decode("%;)/\xB1#$%%<;)=.##&&!&'#/B#;/.. &%;+/& 8!:R! )/($8\":S\"! )(\"'#&'#/[#0X*%%<;)=.##&&!&'#/B#;/.. &%;+/& 8!:R! )/($8\":S\"! )(\"'#&'#&&&#/1$;)/($8#:T#!!)(#'#(\"'#&'#.\xBB &%;(/\xB1#$%%<;(=.##&&!&'#/B#;/.. &%;+/& 8!:R! )/($8\":S\"! )(\"'#&'#/[#0X*%%<;(=.##&&!&'#/B#;/.. &%;+/& 8!:R! )/($8\":S\"! )(\"'#&'#&&&#/1$;(/($8#:T#!!)(#'#(\"'#&'#"),
        peg$decode("4U\"\"5!7V"),
        peg$decode("%$;0.# &;./,#0)*;0.# &;.&&&#/' 8!:W!! )"),
        peg$decode("4X\"\"5!7Y"),
        peg$decode("%$;./&#0#*;.&&&#/' 8!:Z!! )"),
        peg$decode("%2[\"\"6[7\\/\xBE#%$2[\"\"6[7\\0)*2[\"\"6[7\\&/\x93#%$%%<2[\"\"6[7\\=.##&&!&'#/,#;2/#$+\")(\"'#&'#/K#0H*%%<2[\"\"6[7\\=.##&&!&'#/,#;2/#$+\")(\"'#&'#&&&#/' 8!:W!! )/'$8\":]\" )(\"'#&'#/($8\":^\"! )(\"'#&'#"),
        peg$decode("%2_\"\"6_7`/1#;3/($8\":^\"! )(\"'#&'#"),
        peg$decode("%$;4/&#0#*;4&&&#/' 8!:a!! )")
      ],
